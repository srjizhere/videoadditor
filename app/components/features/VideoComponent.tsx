...
import { DaisyUISpinner } from "../ui/DaisyUIProgress";
          ...
          <div className="relative w-full h-full">
            ...
            {!isVideoLoaded && (
              <div className="absolute inset-0 bg-base-200 flex items-center justify-center">
                <DaisyUISpinner size="lg" color="primary" />
              </div>
            )}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 rounded-full transition-all duration-200 hover:bg-base-200"
            >
              <LikeBadge count={likes} liked={isLiked} />
            </button>

            <button className="flex items-center gap-2 px-3 py-2 rounded-full hover:bg-base-200 transition-colors">
              <ShareBadge count={0} />
            </button>
        ...
        <div className="flex items-center gap-3 mt-4 pt-4 border-t border-base-300">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2">
              <TimeBadge time={video.createdAt || new Date()} />
            </div>
          </div>
        </div>
      </div>
